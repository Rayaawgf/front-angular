...
import { ReactiveFormsModule } from '@angular/forms'; // Importez ReactiveFormsModule pour FormGroup
...
@NgModule({
  ...
  imports: [
    ...
    HttpClientModule,
    FormsModule,
    ReactiveFormsModule, // Ajoutez ReactiveFormsModule ici pour utiliser FormGroup
  ],
  providers: [],
